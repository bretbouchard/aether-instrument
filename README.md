...
Aether is a professional JUCE audio instrument plugin for macOS and iOS.

## Overview

This repository contains the complete implementation of the Aether instrument, including:
...
```bash
# Clone repository
git clone git@github.com:bretbouchard/aether-instrument.git
cd aether-instrument
...
Aether instrument for White Room.
...
./render_instrument.sh aether
```

## Repository Information

- **Repository**: https://github.com/bretbouchard/aether-instrument
